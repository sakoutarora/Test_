...
print(w3.eth.get_balance('0x19E35915cdf5D5583472760fae2aF71F98673fA6'))    # 100000000000000000000 or 100 eth 
print(w3.fromWei(w3.eth.get_balance('0x19E35915cdf5D5583472760fae2aF71F98673fA6'), 'ether'))